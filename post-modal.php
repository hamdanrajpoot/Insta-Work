...
.caption-section {
    padding: 0; /* Remove all padding */
    margin-left: 0; /* Remove left margin to balance layout */
    margin-right: 0; /* Remove right margin */
}
</style>
...
<div class="post-underlay d-none min-vh-100 w-100 z-3 position-fixed top-0">
    <form action="./upload-post.php" method="POST" enctype="multipart/form-data"
     class="position-absolute col-xl-6 col-lg-7 col-md-8 col-10 top-50 start-50 translate-middle bg-white py-4 post-box text-center position-relative">
        ...
        <button class="next-btn2 bg-transparent border-0 p-0 fw-semibold m-0 position-absolute cursor-pointer d-none text-primary" style="right:10px"> Share</button>
        ...
        <div class="d-flex" style="height:85%">
            ...
            <!-- Right Section -->
            <div class="caption-section position-relative mx-0 hide-textarea d-flex flex-column justify-content-between py-3">
                ...
                <div class="d-flex gap-3 align-items-center">
                    ...
                    <h6><?php echo $_SESSION['ticket']?></h6>
                </div>
                <textarea name="caption" class="form-control my-3 border-0" rows="10" placeholder="Caption..." style="resize: none;"></textarea>
            </div>
