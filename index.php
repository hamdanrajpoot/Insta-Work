                    ...
                    <div class="d-flex p-2 justify-content-between align-items-center">
                        <div class="d-flex  gap-1 align-items-center">
                            <div class="rounded-circle  border-warning d-flex justify-content-center align-items-center"
                                ...
                                <img src="https://i.postimg.cc/3rvF15Pg/Whats-App-Image-2025-08-04-at-22-37-40-7bb39afb.jpg"
                                    class="object-fit-cover rounded-circle" width="93%" height="93%" alt="">
                            </div>
                            <h6 class="m-0" style="font-size:0.7rem">Hamdan Rajpoot</h6>
                            <i class="bi bi-dot"></i>
                            ...
                            <div class="d-flex  gap-1 align-items-center">
                                ...
                                <div class="">
                                    <div class="d-flex gap-2">
                                        <h6 class="m-0" style="font-size:0.7rem">Hamdan</h6>
